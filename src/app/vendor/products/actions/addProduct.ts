...
//1.Inside the component that uses it (Server Components only).//define function on top of component & make it async or define it inside the server component
...
//if defining a server action function in same file as the component, that component must be a server component.
//add "use server" directive at the top of the function. If in a diff file, add it at the top of the server actions file
